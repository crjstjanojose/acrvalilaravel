        ...
        <div class="login-box">
            <form class="login-form" method="POST" action="{{ route('usuario.update.senha') }}" autocapitalize="false">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control @error('confirma') is-invalid @enderror" type="password" placeholder="Nova senha" name="nova" required>
                </div>
                <div class="form-group">
                    <label class="">Senha Atual</label>
                    <input class="form-control @error('confirma') is-invalid @enderror" type="password" placeholder="Confirmação" name="confirma" required>
                    <span id="error-confirma" class="help-block text-danger">{{ $errors->first('confirma') }}</span>
                </div>
                <div class="form-group ">
                    <div class="row">
                        <div class="col-md-5">
                            <p class="semibold-text mb-2"><a href="{{ route('home') }}" data-toggle="flip">
                                    Retornar</a></p>
                        </div>
                        <div class="col-md-7">
                            <button class="btn btn-primary btr-sm mb-4" type="submit"><i class="fa fa-check"></i>
                                Alterar
                        </div>
                    </div>
                    </button>
