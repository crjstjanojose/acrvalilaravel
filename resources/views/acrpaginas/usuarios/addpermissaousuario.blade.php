...
@section('titulo','Adiciona Permissão ao Usuário')
@section('conteudo')
    ...
    <div class="tile">
        <div class="col-md-12">
            ...
            <div class="tile-body">
                ...
                <form action="{{ route('postadiciona.permissao.usuario',$user->id) }}" method="post">
                    @csrf
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="tile-footer">
                                    <div class="row">
                                        <div class="form-group col-md-12 d-flex flex-row justify-content-end">
                                            <a class="btn btn-secondary mr-2" href="{{  route('users.index') }}"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
