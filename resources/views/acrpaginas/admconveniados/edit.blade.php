...
<main class="app-content">
    <div class="app-title">
        <div>
            <h1 class="my-2"><i class="fa fa-dashboard"></i> Edição de Conveniado </h1>
        </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                <div class="tile-body">
                    <form method="POST" action="{{ route('admconveniados.update',$conveniado->id) }}" autocomplete="off">
                        @csrf
                        @method('PATCH')
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input class="form-control @error('email') is-invalid @enderror" type="email" placeholder="E-mail" name="email" value="{{ old('email') ? old('email') : $conveniado->email }}" id="email">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                <label class=" control-label" for="observacao">Observação Convênio</label>
                        ...
                        <div class="row">
                            <div class="form-group col-md-10">
                                <label class=" control-label" for="observacao_administracao">Observação Administração</label>
                                <textarea class="form-control" name="observacao_administracao" id="observacao_administracao" rows="3">{{ $conveniado->observacao_administracao }}</textarea>
                            </div>
                            <div class="form-group col-md-2">
                                <label class="control-label col-md-3" for="credito">Crédito</label>
                                <select name="credito" id="credito" class="form-control">
                                    <option value="Liberado" {{ old('credito') ? old('credito') :   $conveniado->credito == 'Liberado' ? 'selected' : '' }}> Liberado</option>
                                    <option value="Bloqueado" {{ old('credito') ? old('credito') : $conveniado->credito == 'Bloqueado' ? 'selected' : '' }}>Bloqueado</option>
                                </select>
                            </div>
