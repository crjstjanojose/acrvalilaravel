...
<main class="app-content">
    <div class="app-title">
        <div>
            <h1 class="my-3"><i class="fa fa-list-ul"></i> Encomendas Pendentes</h1>
        ...
        <ul class="app-breadcrumb breadcrumb">
            ...
            <li class="mx-1">
                <a class="btn btn-sm btn-secondary" href="{{ route('encomendas.index.solcitadas') }}" title="Criar nova encomenda"><i class="icon fa fa-industry" aria-hidden="true"></i> Solicitadas</a>
            </li>
            @endcan
            @can('encomenda-listar-entregue')
            <li class="mx-1">
                <a class="btn btn-sm btn-info" href="{{ route('encomendas.index.entregues') }}" title="Criar nova encomenda"><i class="fa fa-truck" aria-hidden="true"></i> Entregues</a>
            </li>
            @endcan
...
<script type="text/javascript">
    $('#getPendentes').DataTable({
        serverSide: false
        , processing: true
        , "ajax": "{{ route('encomendas.table.pendentes') }}"
        , "columns": [{
                data: 'id'
            }
            , {
