...
<main class="app-content">
    <div class="app-title">
        <div>
            <h1><i class="fa fa-dashboard"></i> Confirma Cancelamento da Entrega ?</h1>
        </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                <form action="{{  route('encomendas.confirma.cancela.entrega',$encomenda->id) }}" method="post">
                    @csrf
                    <div class="row">
                        <div class="col-sm-8">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ $encomenda->situacao_pedido }}"
                                    disabled>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tile-footer">
                        <div class="row">
                            ...
                            <div class="form-group col-md-12 d-flex flex-row justify-content-end">
                                ...
                                <button type="submit" class="btn btn-sm btn-primary "> <i class="fa fa-database"
                                        aria-hidden="true"> </i>
                                    Cancela Entrega </button>
