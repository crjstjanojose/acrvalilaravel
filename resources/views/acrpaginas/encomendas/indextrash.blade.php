...
<main class="app-content">
    <div class="app-title">
        <div>
            <h1 class="my-3"><i class="fa fa-list-ul"></i> Encomendas Canceladas</h1>

        </div>
        <ul class="app-breadcrumb breadcrumb">
            @can('encomenda-listar-pendente')
            <li class="mx-1">
                <a class="btn btn-sm btn-primary" href="{{ route('encomendas.index') }}" title="Criar nova encomenda"><i class="icon fa fa-sticky-note-o" aria-hidden="true"></i>
                    Pendentes</a>
            </li>
            @endcan
