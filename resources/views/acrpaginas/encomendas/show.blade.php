...
<main class="app-content">
    <div class="app-title">
        <div>
            <h1><i class="fa fa-dashboard"></i> Visualizaçaõ de Encomenda {{ $encomenda->situacao_pedido }}</h1>
        </div>
                ...
                <div class="tile-footer">
                    <div class="row">
                        ...
                        <div class="form-group col-md-12 d-flex flex-row justify-content-end">
                            <a class="btn btn-info mr-2" href="{{  route('encomendas.index') }}"><i
                                    class="fa fa-fw fa-lg fa-times-circle"></i> Encomendas Pendentes </a>
                            @elseif($encomenda->situacao_pedido == 'Entregue')
                            <div class="form-group col-md-12 d-flex flex-row justify-content-end">
                                <a class="btn btn-info mr-2" href="{{  route('encomendas.index.entregues') }}"><i
                                        class="fa fa-fw fa-lg fa-times-circle"></i> Encomendas Entregues </a>
                                @elseif($encomenda->situacao_pedido == 'Solicitado')
                                <div class="form-group col-md-12 d-flex flex-row justify-content-end">
                                    <a class="btn btn-info mr-2" href="{{  route('encomendas.index.solcitadas') }}"><i
                                            class="fa fa-fw fa-lg fa-times-circle"></i> Encomendas Solicitas</a>
                                    @endif
